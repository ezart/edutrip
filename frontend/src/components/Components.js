                ...
                <div className="col-md-7">
                    <form>
                        ...
                        <div className="form-group has-warning">
                            ...
                            {this.state.number > 80 || this.state.number !='' || isNaN(this.state.number)&& <div className="form-control-feedback text-warning">Please input a number between 5 and 80</div>}
                        </div>
                        <div className="form-group">
